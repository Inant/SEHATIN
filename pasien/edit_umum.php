...
<html lang="en">
<head>
	<title>Edit Pasien Kategori Umum | Sehatin</title>
	<meta charset="utf-8">
...
<body>
	...
	<div id="wrapper">
		<?php
			...
			$query = "SELECT * FROM pasien WHERE id_umum = '$_GET[id_umum]'";
							...
							<div class="panel">
								...
								<div class="panel-body">
									<form method="POST" action="">
										<input type="hidden" name="id_umum" value="<?php echo $val['id_umum']?>">
										<div class="row">
											<div class="col-md-6">
												<input type="text" name="nama" class="form-control" placeholder="Nama Pasien Umum" value="<?php echo($val['nama']) ?>">
										...
										<div class="row">
											<div class="col-md-6">
												<textarea name="alamat" class="form-control" rows="2"><?php echo $val['alamat'] ?>Alamat</textarea>
