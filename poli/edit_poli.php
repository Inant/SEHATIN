	...
	<div id="wrapper">
		<?php
			...
			if ($_SERVER["REQUEST_METHOD"] == "POST") {
				...
				if ($poli_err == "") {
					mysqli_query($con, "UPDATE poli SET poli = '$poli' WHERE id_poli = '$_POST[id_poli]'");
					echo "<script>
							...
							<div class="panel">
								...
								<div class="panel-body">
									<form method="POST" action="">
										...
										<input type="text" name="poli" class="form-control" placeholder="Masukan nama poli" value="<?php echo isset($_POST['submit']) ? $_POST['poli'] : $val['poli'] ?>">
