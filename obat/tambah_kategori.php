...
<html lang="en">	
<head>
	<title>Tambah Kategori Obat | Sehatin</title>
	<meta charset="utf-8">
	...
	<div id="wrapper">
		<?php 
			...
			if ($_SERVER["REQUEST_METHOD"] == "POST") {
				...
				if ($kategori_err == "") {
					mysqli_query($con, "INSERT INTO kategori_obat (kategori) VALUE ('$kategori')");
					echo "<script>
		...
		<div class="main">
			<div class="main-content">
				<div class="container-fluid">
					<h3 class="page-title">Kategori Obat</h4>
						<div class="row">
							<div class="col-md-6">
								<div class="panel">
									<div class="panel-heading">
										<h4 class="panel-title">Tambah Kategori Obat</h4>
									</div>
									<div class="panel-body">
										<form method="POST" action="">
											
											<input type="text" name="kategori" class="form-control" placeholder="Masukan Kategori Obat" value="<?php echo isset($_POST['kategori']) ? $_POST['kategori'] : $kategori ?>">
