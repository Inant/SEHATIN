...
<body>
    ...
    $nm_obat = $kategori = $satuan = $hbeli = $hjual = $stok = $tgl = "";
      ...
      if ($nm_obat_err == "" && $kategori_err == "" && $satuan_err == "" && $hbeli_err == "" && $hjual_err == "" && $stok_err == "" && $tgl_err == "") {
        mysqli_query($con, "UPDATE obat SET nm_obat = '$nm_obat', id_kategori = '$kategori' , id_satuan = '$satuan', harga_beli = '$hbeli', harga_jual = '$hjual', stok = '$stok', tgl_kadaluarsa = '$tgl' WHERE id_obat = '$_POST[id_obat]'");
        echo "<script>
		 ...
		 <div class="main">
          ...
          <div class="panel">
            <div class="panel-heading">
              <h1 class="panel-title"><i class="fa fa-medkit"></i>&ensp;Edit Obat</h1>
            </div>
          </div>
		 			<div class="row">
		 				<div class="col-md-12">
                    ...
                    <input type="hidden" name="id_obat" value="<?php echo($val['id_obat']) ?>">
		 								<div class="row">
		 									<div class="col-md-6">
                    ...
                    <div class="row">
		 									<div class="col-md-6">
												<label for="">Stok</label>
		 										<input type="number" name="stok" placeholder="Stok" class="form-control" value="<?php echo($val['stok']) ?>">
