        ...
        <div class="row">
          <div class="col-md-12">
            ...
            <div class="panel-heading">
                <h4 class="panel-title">Antrian Poli Umum</h4>
                      ...
                      <table class="table table-striped table-hover table-bordered">
                        ...
                        <tbody>
                          ...
                          if (isset($_POST['btn_cari'])) {
                            ...
                            $query = "SELECT DISTINCT p.*, a.id_antrian,a.status, a.waktu, k.kategori_pasien, a.keluhan FROM pasien p INNER JOIN kategori_pasien k ON k.id_kategori_pasien = p.id_kategori_pasien INNER JOIN antrian a ON a.id_pasien = p.id_pasien INNER JOIN poli ON a.id_poli = poli.id_poli WHERE a.id_poli = 1 AND waktu BETWEEN '$now 00:00:00' AND '$now 23:59:59' ORDER BY a.waktu ASC";
                          }
