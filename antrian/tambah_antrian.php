          ...
          if (empty($_POST['keluhan']) || $_POST['keluhan'] == "Keluhan") {
            ...
            $keluhan = $_POST['keluhan'];
					...
					if ($nama_err == "" && $poli_err == "" && $keluhan_err == "") {
						mysqli_query($con, "INSERT INTO antrian (id_pasien, waktu, status, id_poli, keluhan) VALUE((SELECT id_pasien FROM pasien WHERE nama = '$nama'), '$waktu', 'Mengantri', '$poli', '$keluhan')");
					  echo "<script>
			 		...
			 		<div class="container-fluid">
						...
						<div class="row">
                          ...
                          <label for="">Nama Pasien</label>
													<input type="text" id="nama" name="nama" value="<?php echo(isset($_POST['nama']) ? $_POST['nama'] : '') ?>" placeholder="Nama pasien" class="form-control">
                          ...
                          <select class="form-control" name="poli">
                            ...
                            <?php
                              ...
                              while ($val = mysqli_fetch_assoc($qpoli)) {
                                echo "<option value = '$val[id_poli]'>$val[poli] </option>";
                              }
                             ?>
                          </select>
                      ...
                      <div class="row">
                        <div class="col-md-6">
                          ...
                          <textarea name="keluhan" class="form-control"><?php echo $keluhan ?></textarea>
