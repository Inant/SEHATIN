                      ...
                      <table class="table table-striped table-hover">
                        ...
                        <tbody>
                          ...
                          foreach ($result as $val) {
                            ...
                            <td>$val[keluhan]</td>
                            <td> <a href='form_pembayaran.php?id_pasien=$val[id_pasien]&id_antrian=$val[id_antrian]&id_pemeriksaan=$val[id_pemeriksaan]' class='btn btn-primary btn-xs' title='Bayar' ><i class='fa fa-money'></i> </a> </td>
                            </tr>
                            ";
                            $no++;
                          }
