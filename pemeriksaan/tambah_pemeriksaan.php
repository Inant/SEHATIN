		 		...
		 		<div class="container-fluid">
		 			<div class="panel">
						<div class="panel-heading">
							<div class="row">
								<div class="col-md-4">
									<h3 class="panel-title"><i class="fa fa-stethoscope"></i>&ensp;Pemeriksaan</h3>
								</div>
							</div>
						</div>
					</div>
                          ...
                          $pelayanan_err)?></span>
		 								...
		 								<div class="row">
		 									<div class="col-md-6">
		 										...
		 										<button type="reset" name="reset" class="btn btn-danger"><i class="fa fa-times-circle"></i> &nbsp;  Reset</button>
		 									</div>
		 								</div>
		 							</form>
		 						</div>
